...
(1, 'Lòng mẹ', 'Lòng mẹ', 5, '                                                                                    Và mẹ ơi đừng khóc nhé! Cả đời này mẹ đã khóc nhiều lắm rồi, hãy cười lên vì con đã trưởng thành! Con sẽ lại về dậy sớm nấu cơm cho mẹ, nấu nước cho mẹ tắm như ngày xưa. “Dù cho vai nắng nhưng lòng thương chẳng nhạt màu, vẫn mơ quay về vui vầy dưới bóng mẹ yêu”                                                                        ', NULL, 2, '2012-07-23 00:00:00', NULL),
...
ALTER TABLE `baiviet`
  ...
  ADD UNIQUE KEY `ma_bviet` (`ma_bviet`),
...
ALTER TABLE `theloai`
  ...
  ADD UNIQUE KEY `ma_tloai` (`ma_tloai`);
